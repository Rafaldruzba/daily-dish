												...
												.map(r => (
													<div
														...
														<div className='flex flex-wrap gap-2'>
															<button
																onClick={() => handleAdminSubscriptionUpdate(r.id, 'EXTEND_TRIAL')}
										...
										<div className='overflow-x-auto border border-stone-200'>
											<table className='min-w-full bg-white text-xs font-mono divide-y divide-stone-200'>
												...
												<tbody className='divide-y divide-stone-200'>
													{adminPayments.map(p => (
														<tr key={p.id}>
															<td className='px-6 py-4 font-serif font-bold text-left'>
																{p.restaurant?.name || 'N/A'}
															</td>
												...
												<article
													...
													<div className='flex items-start justify-between gap-4'>
														...
														<div className='text-right bg-stone-50 border p-3 min-w-[90px]'>
															...
															<span className='block font-serif text-2xl font-black text-stone-900'>
																{rest.views || 0}
															</span>
														</div>
													</div>
								...
								<section className='space-y-8 text-left'>
									<div>
										...
										<p className='text-stone-500 text-xs mt-1'>
											Kontroluj statusy subskrypcji oraz aktywuj dodatkowe moduły promujące dla każdego ze swoich
											lokali.
										</p>
									</div>
									{loading ? (
										...
										<div className='space-y-6'>
											{ownedRestaurants.map(rest => {
												...
												const hasPromotion = rest.subscriptions?.some(
													s => s.type === 'PROMOTION' && s.status === 'ACTIVE',
												)
